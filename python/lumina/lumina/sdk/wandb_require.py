...
import lumina
from lumina.errors import UnsupportedError
...
class _Requires:
    ...
    def require_service(self) -> None:
        lumina.termwarn("`wandb.require('service')` is a no-op as it is now the default behavior.")

    def require_core(self) -> None:
        lumina.termwarn("`wandb.require('core')` is a no-op as it is now the default behavior.")
