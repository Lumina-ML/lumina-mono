...
from lumina.util import json_dumps_safer, json_friendly
...
class InterfaceShared(InterfaceBase, abc.ABC):
    ...
    @override
    def _publish_output(self, outdata: pb.OutputRecord, *, nowait: bool=False) -> None:
        rec = pb.Record()
        rec.output.CopyFrom(outdata)
        self._publish(rec, nowait=nowait)

    @override
    def _publish_output_raw(self, outdata: pb.OutputRawRecord, *, nowait: bool=False) -> None:
        rec = pb.Record()
        rec.output_raw.CopyFrom(outdata)
        self._publish(rec, nowait=nowait)

    @override
    def _publish_output_logger(self, outdata: pb.OutputLoggerRecord, *, nowait: bool=False) -> None:
        rec = pb.Record()
    ...
    def _publish_partial_history(self, partial_history: pb.PartialHistoryRequest) -> None:
    ...
    def _publish_job_input(self, job_input: pb.JobInputRequest) -> MailboxHandle[pb.Result]:
    ...
    def _make_request(self, get_summary: pb.GetSummaryRequest | None=None, pause: pb.PauseRequest | None=None, resume: pb.ResumeRequest | None=None, status: pb.StatusRequest | None=None, network_status: pb.NetworkStatusRequest | None=None, poll_exit: pb.PollExitRequest | None=None, partial_history: pb.PartialHistoryRequest | None=None, sampled_history: pb.SampledHistoryRequest | None=None, run_start: pb.RunStartRequest | None=None, check_version: pb.CheckVersionRequest | None=None, log_artifact: pb.LogArtifactRequest | None=None, download_artifact: pb.DownloadArtifactRequest | None=None, link_artifact: pb.LinkArtifactRequest | None=None, defer: pb.DeferRequest | None=None, attach: pb.AttachRequest | None=None, server_info: pb.ServerInfoRequest | None=None, keepalive: pb.KeepaliveRequest | None=None, run_status: pb.RunStatusRequest | None=None, sender_mark: pb.SenderMarkRequest | None=None, sender_read: pb.SenderReadRequest | None=None, sync_finish: pb.SyncFinishRequest | None=None, status_report: pb.StatusReportRequest | None=None, cancel: pb.CancelRequest | None=None, summary_record: pb.SummaryRecordRequest | None=None, telemetry_record: pb.TelemetryRecordRequest | None=None, get_system_metrics: pb.GetSystemMetricsRequest | None=None, python_packages: pb.PythonPackagesRequest | None=None, job_input: pb.JobInputRequest | None=None, probe_system_info: pb.ProbeSystemInfoRequest | None=None) -> pb.Record:
        request = pb.Request()
        if get_summary:
    ...
    def _make_record(self, run: pb.RunRecord | None=None, config: pb.ConfigRecord | None=None, files: pb.FilesRecord | None=None, summary: pb.SummaryRecord | None=None, history: pb.HistoryRecord | None=None, stats: pb.StatsRecord | None=None, exit: pb.RunExitRecord | None=None, artifact: pb.ArtifactRecord | None=None, tbrecord: pb.TBRecord | None=None, alert: pb.AlertRecord | None=None, final: pb.FinalRecord | None=None, metric: pb.MetricRecord | None=None, header: pb.HeaderRecord | None=None, footer: pb.FooterRecord | None=None, request: pb.Request | None=None, telemetry: tpb.TelemetryRecord | None=None, preempting: pb.RunPreemptingRecord | None=None, use_artifact: pb.UseArtifactRecord | None=None, output: pb.OutputRecord | None=None, output_raw: pb.OutputRawRecord | None=None, environment: pb.EnvironmentRecord | None=None) -> pb.Record:
        record = pb.Record()
        if run:
    ...
    def _deliver_finish_sync(self, sync_finish: pb.SyncFinishRequest) -> MailboxHandle[pb.Result]:
    ...
    def _deliver_get_system_metrics(self, get_system_metrics: pb.GetSystemMetricsRequest) -> MailboxHandle[pb.Result]:
    ...
    def _deliver_attach(self, attach: pb.AttachRequest) -> MailboxHandle[pb.Result]:
        record = self._make_request(attach=attach)
        return self._deliver(record)

    def _deliver_network_status(self, network_status: pb.NetworkStatusRequest) -> MailboxHandle[pb.Result]:
