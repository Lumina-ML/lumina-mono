...
class LinkArtifactInput(GQLInput):
    ...
    artifact_portfolio_id: GQLId | None = Field(alias='artifactPortfolioID', default=None)
    artifact_portfolio_name: str | None = Field(alias='artifactPortfolioName', default=None)
...
class RateLimitsInput(GQLInput):
    ...
    create_artifacts_request_count: int | None = Field(alias='createArtifactsRequestCount', default=None)
    create_artifacts_time_window: int | None = Field(alias='createArtifactsTimeWindow', default=None)
    filestream_count: float | None = Field(alias='filestreamCount', default=None)
    filestream_per_run_count: float | None = Field(alias='filestreamPerRunCount', default=None)
    ...
    sdk_graphql_query_seconds: float | None = Field(alias='sdkGraphqlQuerySeconds', default=None)
...
class TagInput(GQLInput):
    ...
    tag_category_name: str | None = Field(alias='tagCategoryName', default=None, max_length=128, pattern='^[-\\w]+([ ]+[-\\w]+)*$')
    tag_name: str = Field(alias='tagName', max_length=128, pattern='^[-\\w]+([ ]+[-\\w]+)*$')
...
class UpsertModelInput(GQLInput):
    ...
    allow_all_artifact_types_in_registry: bool | None = Field(alias='allowAllArtifactTypesInRegistry', default=None)
    artifact_types: list[ArtifactTypeInput] | None = Field(alias='artifactTypes', default=None)
    client_mutation_id: str | None = Field(alias='clientMutationId', default=None)
    description: str | None = None
