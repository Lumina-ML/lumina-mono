...
class RegistryCollectionsOrganization(GQLResult):
    org_entity: RegistryCollectionsOrganizationOrgEntity | None = Field(alias='orgEntity')

class RegistryCollectionsOrganizationOrgEntity(GQLResult):
    name: str
    artifact_collections: RegistryCollectionsOrganizationOrgEntityArtifactCollections | None = Field(alias='artifactCollections')
