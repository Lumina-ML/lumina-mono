...
class ProjectArtifactsProject(GQLResult):
    artifact_type: ProjectArtifactsProjectArtifactType | None = Field(alias='artifactType')

class ProjectArtifactsProjectArtifactType(GQLResult):
    artifact_collection: ProjectArtifactsProjectArtifactTypeArtifactCollection | None = Field(alias='artifactCollection')
