...
from lumina.sdk.lib.filesystem import mkdir_exists_ok
from lumina.sdk.lib.paths import FilePathStr
...
def get_staging_dir() -> FilePathStr:
    ...
    try:
        ...
        raise PermissionError(f'Unable to write staging files to {path}. To fix this problem, please set {env.DATA_DIR} to a directory where you have the necessary write access.') from e
