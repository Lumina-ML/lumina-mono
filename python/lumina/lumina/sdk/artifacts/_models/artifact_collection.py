...
if TYPE_CHECKING:
    from lumina.sdk.artifacts._generated import ArtifactCollectionFragment
...
class ArtifactCollectionData(ArtifactsBase):
    ...
    def _validate_name(cls, v: str) -> str:
        from lumina.sdk.artifacts._validators import validate_artifact_name
    ...
    def _validate_tags(cls, v: Any) -> list[str]:
        ...
        from lumina.sdk.artifacts._validators import validate_tags
    ...
    def from_fragment(cls, obj: ArtifactCollectionFragment) -> Self:
        ...
        return cls(typename__=obj.typename__, id=obj.id, name=obj.name, type=obj.type.name, description=obj.description, created_at=obj.created_at, updated_at=obj.updated_at, project=obj.project.name, entity=obj.project.entity.name, tags=[e.node.name for e in obj.tags.edges if e.node], aliases=None)
