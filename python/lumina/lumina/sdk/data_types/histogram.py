    ...
    def __init__(self, sequence: Sequence | None=None, np_histogram: NumpyHistogram | None=None, num_bins: int=64) -> None:
        ...
        if np_histogram:
            if len(np_histogram) == 2:
                ...
                raise ValueError('Expected np_histogram to be a tuple of (values, bin_edges) or sequence to be specified')
        else:
            np = util.get_module('numpy', required='Auto creation of histograms requires numpy')
