...
class Classes(Media):
    ...
    @classmethod
    def from_json(cls: type[Classes], json_obj: dict, source_artifact: Artifact | None) -> Classes:
...
class _ClassesIdType(_dtypes.Type):
    ...
    def __init__(self, classes_obj: Classes | None=None, valid_ids: _dtypes.UnionType | None=None):
