...
class AzureEnvironment(AbstractEnvironment):
    ...
    async def upload_file(self, source: str, destination: str) -> None:
        ...
        try:
            client = BlobClient(f'https://{storage_account}.blob.core.windows.net', storage_container, path, credential=creds)
    ...
    async def verify_storage_uri(self, uri: str) -> None:
        ...
        try:
            ...
            raise LaunchError(f'Could not verify storage URI {uri} in container {storage_container}.') from e
