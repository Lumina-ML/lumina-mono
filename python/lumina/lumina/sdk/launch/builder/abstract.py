...
from ..utils import AZURE_CONTAINER_REGISTRY_URI_REGEX, ELASTIC_CONTAINER_REGISTRY_URI_REGEX, GCP_ARTIFACT_REGISTRY_URI_REGEX
if TYPE_CHECKING:
...
class AbstractBuilder(ABC):
    ...
    @abstractmethod
    def __init__(self, environment: AbstractEnvironment, registry: AbstractRegistry, verify: bool=True) -> None:
    ...
    @classmethod
    @abstractmethod
    def from_config(cls, config: dict, environment: AbstractEnvironment, registry: AbstractRegistry) -> AbstractBuilder:
