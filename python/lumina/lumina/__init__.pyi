...
from lumina.sdk.lib.deprecation import UNSET, DoNotSet
__all__ = ('__version__', 'init', 'finish', 'setup', 'login', 'save', 'sweep', 'controller', 'agent', 'config', 'log', 'summary', 'Api', 'Graph', 'Image', 'Plotly', 'Video', 'Audio', 'Table', 'EvalTable', 'Html', 'box3d', 'Object3D', 'Molecule', 'Histogram', 'ArtifactTTL', 'log_artifact', 'use_artifact', 'log_model', 'use_model', 'link_model', 'define_metric', 'Error', 'termsetup', 'termlog', 'termerror', 'termwarn', 'Artifact', 'Settings', 'teardown', 'watch', 'unwatch', 'plot', 'plot_table', 'restore', 'Run')
import os
from collections.abc import Callable, Iterable, Sequence
from typing import TYPE_CHECKING, Any, Literal, TextIO
import lumina.plot as plot
from lumina.apis import InternalApi
from lumina.apis import PublicApi as Api
from lumina.data_types import Audio, EvalTable, Graph, Histogram, Html, Image, Molecule, Object3D, Plotly, Table, Video, box3d
from lumina.errors import Error
from lumina.errors.term import termerror, termlog, termsetup, termwarn
from lumina.sdk import Artifact, Settings, wandb_config, wandb_metric, wandb_summary
...
from lumina.sdk.wandb_setup import _WandbSetup
from lumina.wandb_controller import _WandbController
if TYPE_CHECKING:
    import torch
    import lumina
    from lumina.plot import CustomChart
...
def require(requirement: str | Iterable[str] | None=None, experiment: str | Iterable[str] | None=None) -> None:
...
def login(key: str | None=None, relogin: bool | None=None, host: str | None=None, force: bool | None=None, timeout: int | None=None, verify: bool=False, referrer: str | None=None, anonymous: DoNotSet=UNSET) -> bool:
    """Log into W&B.
...
def save(glob_str: str | os.PathLike, base_path: str | os.PathLike | None=None, policy: PolicyName='live', glob: bool=True) -> bool | list[str]:
...
def sweep(sweep: dict | Callable, entity: str | None=None, project: str | None=None, prior_runs: list[str] | None=None) -> str:
...
def controller(sweep_id_or_config: str | dict | None=None, entity: str | None=None, project: str | None=None) -> _WandbController:
...
def define_metric(name: str, step_metric: str | wandb_metric.Metric | None=None, step_sync: bool | None=None, hidden: bool | None=None, summary: str | None=None, goal: str | None=None, overwrite: bool | None=None) -> wandb_metric.Metric:
...
def log_artifact(artifact_or_path: Artifact | StrPath, name: str | None=None, type: str | None=None, aliases: list[str] | None=None, tags: list[str] | None=None) -> Artifact:
...
def use_artifact(artifact_or_name: str | Artifact, type: str | None=None, aliases: list[str] | None=None, use_as: str | None=None) -> Artifact:
...
def log_model(path: StrPath, name: str | None=None, aliases: list[str] | None=None) -> None:
...
def link_model(path: StrPath, registered_model_name: str, name: str | None=None, aliases: list[str] | None=None) -> Artifact | None:
...
def watch(models: torch.nn.Module | Sequence[torch.nn.Module], criterion: torch.F | None=None, log: Literal['gradients', 'parameters', 'all'] | None='gradients', log_freq: int=1000, idx: int | None=None, log_graph: bool=False) -> None:
...
def unwatch(models: torch.nn.Module | Sequence[torch.nn.Module] | None=None) -> None:
