...
from lumina._pydantic import GQLId, GQLInput
...
class CreateFilterTriggerInput(GQLInput):
    ...
    triggered_action_config: TriggeredActionConfig = Field(alias='triggeredActionConfig')
    triggered_action_type: TriggeredActionType = Field(alias='triggeredActionType')
    triggering_event_type: EventTriggeringConditionType = Field(alias='triggeringEventType')
...
class TriggeredActionConfig(GQLInput):
    generic_webhook_action_input: GenericWebhookActionInput | None = Field(alias='genericWebhookActionInput', default=None)
    no_op_action_input: NoOpTriggeredActionInput | None = Field(alias='noOpActionInput', default=None)
    notification_action_input: NotificationActionInput | None = Field(alias='notificationActionInput', default=None)
    push_notification_action_input: PushNotificationActionInput | None = Field(alias='pushNotificationActionInput', default=None)
    queue_job_action_input: QueueJobActionInput | None = Field(alias='queueJobActionInput', default=None)
...
class UpdateFilterTriggerInput(GQLInput):
    ...
    triggered_action_config: TriggeredActionConfig | None = Field(alias='triggeredActionConfig', default=None)
    triggered_action_type: TriggeredActionType | None = Field(alias='triggeredActionType', default=None)
    triggering_event_type: EventTriggeringConditionType | None = Field(alias='triggeringEventType', default=None)
