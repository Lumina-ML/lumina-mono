...
class IntegrationsByEntityEntityIntegrationsEdges(GQLResult):
    node: Annotated[IntegrationsByEntityEntityIntegrationsEdgesNodeIntegration | WebhookIntegrationFields | SlackIntegrationFields, Field(discriminator='typename__')] | None
