...
from ._generated import ArtifactPortfolioScopeFields, ArtifactSequenceScopeFields, EntityScopeFields, ProjectScopeFields
...
class _ArtifactPortfolioScope(_BaseScope, ArtifactPortfolioScopeFields):
    ...
    scope_type: Literal[ScopeType.ARTIFACT_COLLECTION] = ScopeType.ARTIFACT_COLLECTION
ArtifactCollectionScope = Annotated[_ArtifactSequenceScope | _ArtifactPortfolioScope, BeforeValidator(parse_scope), Discriminator('typename__')]
'Type hint for a scope defined by an `ArtifactCollection`.'
ArtifactCollectionScopeTypes = ArtifactCollectionScope.__origin__
...
EntityScope = Annotated[TeamScope | OrgScope, BeforeValidator(parse_scope), Discriminator('entity_type')]
'Type hint for a scope defined by a team or org `Entity`.'
AutomationScope = Annotated[_ArtifactSequenceScope | _ArtifactPortfolioScope | ProjectScope | EntityScope, BeforeValidator(parse_scope), Discriminator('typename__')]
'Type hint for any allowed scope for an automation.'
AutomationScopeTypes = AutomationScope.__origin__
__all__ = ['ScopeType', 'ArtifactCollectionScope', 'ProjectScope', 'TeamScope', 'OrgScope', 'EntityScope']
