...
to_exception_map = {pb.ErrorInfo.UNKNOWN: Error, pb.ErrorInfo.COMMUNICATION: CommError, pb.ErrorInfo.AUTHENTICATION: AuthenticationError, pb.ErrorInfo.USAGE: UsageError, pb.ErrorInfo.UNSUPPORTED: UnsupportedError}
