...
import lumina
from lumina.sdk.integration_utils.auto_logging import Response
from .utils import chunkify, decode_sdxl_t2i_latents, get_updated_kwargs, postprocess_np_arrays_for_video, postprocess_pils_to_np
logger = logging.getLogger(__name__)
SUPPORTED_MULTIMODAL_PIPELINES = {'BlipDiffusionPipeline': {'table-schema': ['Reference-Image', 'Prompt', 'Negative-Prompt', 'Source-Subject-Category', 'Target-Subject-Category', 'Generated-Image'], 'kwarg-logging': ['reference_image', 'prompt', 'neg_prompt', 'source_subject_category', 'target_subject_category'], 'kwarg-actions': [lumina.Image, None, None, None, None]}, 'BlipDiffusionControlNetPipeline': {'table-schema': ['Reference-Image', 'Control-Image', 'Prompt', 'Negative-Prompt', 'Source-Subject-Category', 'Target-Subject-Category', 'Generated-Image'], 'kwarg-logging': ['reference_image', 'condtioning_image', 'prompt', 'neg_prompt', 'source_subject_category', 'target_subject_category'], 'kwarg-actions': [lumina.Image, lumina.Image, None, None, None, None]}, 'StableDiffusionControlNetPipeline': {'table-schema': ['Control-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionControlNetImg2ImgPipeline': {'table-schema': ['Source-Image', 'Control-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'control_image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, lumina.Image, None, None]}, 'StableDiffusionControlNetInpaintPipeline': {'table-schema': ['Source-Image', 'Mask-Image', 'Control-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'mask_image', 'control_image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, lumina.Image, lumina.Image, None, None]}, 'CycleDiffusionPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Source-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'source_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionInstructPix2PixPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'PaintByExamplePipeline': {'table-schema': ['Source-Image', 'Example-Image', 'Mask-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'example_image', 'mask_image'], 'kwarg-actions': [lumina.Image, lumina.Image, lumina.Image]}, 'RePaintPipeline': {'table-schema': ['Source-Image', 'Mask-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'mask_image'], 'kwarg-actions': [lumina.Image, lumina.Image]}, 'StableDiffusionPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'KandinskyCombinedPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'KandinskyV22CombinedPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'LatentConsistencyModelPipeline': {'table-schema': ['Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt'], 'kwarg-actions': [None]}, 'LDMTextToImagePipeline': {'table-schema': ['Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt'], 'kwarg-actions': [None]}, 'StableDiffusionPanoramaPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'PixArtAlphaPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'StableDiffusionSAGPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'SemanticStableDiffusionPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'WuerstchenCombinedPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'IFPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'AltDiffusionPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'StableDiffusionAttendAndExcitePipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'KandinskyImg2ImgCombinedPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'KandinskyInpaintCombinedPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'KandinskyV22Img2ImgCombinedPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'KandinskyV22InpaintCombinedPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'AnimateDiffPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Number-of-Frames', 'Generated-Video'], 'kwarg-logging': ['prompt', 'negative_prompt', 'num_frames'], 'kwarg-actions': [None, None, None], 'output-type': 'video'}, 'StableVideoDiffusionPipeline': {'table-schema': ['Input-Image', 'Frames-Per-Second', 'Generated-Video'], 'kwarg-logging': ['image', 'fps'], 'kwarg-actions': [lumina.Image, None], 'output-type': 'video'}, 'AudioLDMPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Audio-Length-in-Seconds', 'Generated-Audio'], 'kwarg-logging': ['prompt', 'negative_prompt', 'audio_length_in_s'], 'kwarg-actions': [None, None, None], 'output-type': 'audio'}, 'AudioLDM2Pipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Audio-Length-in-Seconds', 'Generated-Audio'], 'kwarg-logging': ['prompt', 'negative_prompt', 'audio_length_in_s'], 'kwarg-actions': [None, None, None], 'output-type': 'audio'}, 'MusicLDMPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Audio-Length-in-Seconds', 'Generated-Audio'], 'kwarg-logging': ['prompt', 'negative_prompt', 'audio_length_in_s'], 'kwarg-actions': [None, None, None], 'output-type': 'audio'}, 'StableDiffusionPix2PixZeroPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'PNDMPipeline': {'table-schema': ['Batch-Size', 'Number-of-Inference-Steps', 'Generated-Image'], 'kwarg-logging': ['batch_size', 'num_inference_steps'], 'kwarg-actions': [None, None]}, 'ShapEPipeline': {'table-schema': ['Prompt', 'Generated-Video'], 'kwarg-logging': ['prompt'], 'kwarg-actions': [None], 'output-type': 'video'}, 'StableDiffusionImg2ImgPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionInpaintPipeline': {'table-schema': ['Source-Image', 'Mask-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'mask_image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, lumina.Image, None, None]}, 'StableDiffusionDepth2ImgPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionImageVariationPipeline': {'table-schema': ['Source-Image', 'Generated-Image'], 'kwarg-logging': ['image'], 'kwarg-actions': [lumina.Image]}, 'StableDiffusionPipelineSafe': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'StableDiffusionUpscalePipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Upscaled-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionAdapterPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'StableDiffusionGLIGENPipeline': {'table-schema': ['Prompt', 'GLIGEN-Phrases', 'GLIGEN-Boxes', 'GLIGEN-Inpaint-Image', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'gligen_phrases', 'gligen_boxes', 'gligen_inpaint_image', 'negative_prompt'], 'kwarg-actions': [None, None, None, lumina.Image, None]}, 'VersatileDiffusionTextToImagePipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'VersatileDiffusionImageVariationPipeline': {'table-schema': ['Source-Image', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None]}, 'VersatileDiffusionDualGuidedPipeline': {'table-schema': ['Source-Image', 'Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['image', 'prompt', 'negative_prompt'], 'kwarg-actions': [lumina.Image, None, None]}, 'LDMPipeline': {'table-schema': ['Batch-Size', 'Number-of-Inference-Steps', 'Generated-Image'], 'kwarg-logging': ['batch_size', 'num_inference_steps'], 'kwarg-actions': [None, None]}, 'TextToVideoSDPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Number-of-Frames', 'Generated-Video'], 'kwarg-logging': ['prompt', 'negative_prompt', 'num_frames'], 'output-type': 'video'}, 'TextToVideoZeroPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Number-of-Frames', 'Generated-Video'], 'kwarg-logging': ['prompt', 'negative_prompt', 'video_length']}, 'AmusedPipeline': {'table-schema': ['Prompt', 'Guidance Scale', 'Generated-Image'], 'kwarg-logging': ['prompt', 'guidance_scale'], 'kwarg-actions': [None, None]}, 'StableDiffusionXLControlNetPipeline': {'table-schema': ['Prompt-1', 'Prompt-2', 'Control-Image', 'Negative-Prompt-1', 'Negative-Prompt-2', 'Generated-Image'], 'kwarg-logging': ['prompt', 'prompt_2', 'image', 'negative_prompt', 'negative_prompt_2'], 'kwarg-actions': [None, None, lumina.Image, None, None]}, 'StableDiffusionXLControlNetImg2ImgPipeline': {'table-schema': ['Prompt-1', 'Prompt-2', 'Input-Image', 'Control-Image', 'Negative-Prompt-1', 'Negative-Prompt-2', 'Generated-Image'], 'kwarg-logging': ['prompt', 'prompt_2', 'image', 'control_image', 'negative_prompt', 'negative_prompt_2'], 'kwarg-actions': [None, None, lumina.Image, lumina.Image, None, None]}, 'Kandinsky3Pipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt'], 'kwarg-actions': [None, None]}, 'Kandinsky3Img2ImgPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Input-Image', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt', 'image'], 'kwarg-actions': [None, None, lumina.Image]}, 'StableDiffusionXLPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Prompt-2', 'Negative-Prompt-2', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt', 'prompt_2', 'negative_prompt_2'], 'kwarg-actions': [None, None, None, None]}, 'StableDiffusionXLImg2ImgPipeline': {'table-schema': ['Prompt', 'Negative-Prompt', 'Prompt-2', 'Negative-Prompt-2', 'Input-Image', 'Generated-Image'], 'kwarg-logging': ['prompt', 'negative_prompt', 'prompt_2', 'negative_prompt_2', 'image'], 'kwarg-actions': [None, None, None, None, lumina.Image]}}
...
class DiffusersMultiModalPipelineResolver:
    ...
    def __init__(self, pipeline_name: str, pipeline_call_count: int) -> None:
        ...
        if pipeline_name in SUPPORTED_MULTIMODAL_PIPELINES:
            ...
            lumina.Error('Pipeline not supported for logging')
        self.wandb_table = lumina.Table(columns=columns)
    ...
    def __call__(self, args: Sequence[Any], kwargs: dict[str, Any], response: Response, start_time: float, time_elapsed: float) -> Any:
        ...
        try:
            ...
            if 'workflow' not in lumina.config:
                lumina.config.update({'workflow': [{'pipeline': pipeline_configs, 'params': kwargs, 'stage': f'Pipeline-Call-{self.pipeline_call_count}'}]})
            else:
                existing_workflow = lumina.config.workflow
                ...
                lumina.config.update({'workflow': updated_workflow}, allow_val_change=True)
    ...
    def log_media(self, image: Any, loggable_kwarg_chunks: list, idx: int) -> None:
        ...
        if 'output-type' not in SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]:
            try:
                ...
                caption = None
            lumina.log({f'Generated-Image/Pipeline-Call-{self.pipeline_call_count}': lumina.Image(image, caption=caption)})
        elif SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['output-type'] == 'video':
            try:
                prompt_index = SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['kwarg-logging'].index('prompt')
                caption = loggable_kwarg_chunks[prompt_index][idx]
                ...
                caption = None
            lumina.log({f'Generated-Video/Pipeline-Call-{self.pipeline_call_count}': lumina.Video(postprocess_pils_to_np(image), fps=4, caption=caption)})
        elif SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['output-type'] == 'audio':
            try:
                prompt_index = SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['kwarg-logging'].index('prompt')
                caption = loggable_kwarg_chunks[prompt_index][idx]
                ...
                caption = None
            lumina.log({f'Generated-Audio/Pipeline-Call-{self.pipeline_call_count}': lumina.Audio(image, sample_rate=16000, caption=caption)})
    ...
    def add_data_to_table(self, image: Any, loggable_kwarg_chunks: list, idx: int) -> None:
        ...
        if 'output-type' not in SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]:
            table_row.append(lumina.Image(image))
        elif SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['output-type'] == 'video':
            table_row.append(lumina.Video(postprocess_pils_to_np(image), fps=4))
        elif SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['output-type'] == 'audio':
            table_row.append(lumina.Audio(image, sample_rate=16000))
    ...
    def prepare_loggable_dict(self, pipeline: Any, response: Response, kwargs: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.pipeline_name in ['TextToVideoSDPipeline', 'TextToVideoZeroPipeline']:
            ...
            lumina.log({f'Generated-Video/Pipeline-Call-{self.pipeline_call_count}': lumina.Video(video, fps=4, caption=kwargs['prompt'])})
            ...
            table_row.append(lumina.Video(video, fps=4))
            self.wandb_table.add_data(*table_row)
        else:
            loggable_kwarg_ids = SUPPORTED_MULTIMODAL_PIPELINES[self.pipeline_name]['kwarg-logging']
