...
def create_component_from_func(func: Callable, packages_to_install: list[str] | None=None, **kwargs: object) -> Callable:
...
def get_command_and_args_for_lightweight_component(func: Callable, **kwargs: object) -> tuple:
...
get_command_and_args_for_lightweight_component.__name__ = '_get_command_and_args_for_lightweight_component'
