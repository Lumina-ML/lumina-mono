...
class OVERLAPPED(ctypes.Structure):
    _fields_ = [('Internal', LPVOID), ('InternalHigh', LPVOID), ('Offset', ctypes.wintypes.DWORD), ('OffsetHigh', ctypes.wintypes.DWORD), ('Pointer', LPVOID), ('hEvent', ctypes.wintypes.HANDLE)]
...
ReadDirectoryChangesW.argtypes = (ctypes.wintypes.HANDLE, LPVOID, ctypes.wintypes.DWORD, ctypes.wintypes.BOOL, ctypes.wintypes.DWORD, ctypes.POINTER(ctypes.wintypes.DWORD), ctypes.POINTER(OVERLAPPED), LPVOID)
CreateFileW = ctypes.windll.kernel32.CreateFileW
CreateFileW.restype = ctypes.wintypes.HANDLE
CreateFileW.errcheck = _errcheck_handle
CreateFileW.argtypes = (ctypes.wintypes.LPCWSTR, ctypes.wintypes.DWORD, ctypes.wintypes.DWORD, LPVOID, ctypes.wintypes.DWORD, ctypes.wintypes.DWORD, ctypes.wintypes.HANDLE)
...
CreateEvent.argtypes = (LPVOID, ctypes.wintypes.BOOL, ctypes.wintypes.BOOL, ctypes.wintypes.LPCWSTR)
...
CreateIoCompletionPort.argtypes = (ctypes.wintypes.HANDLE, ctypes.wintypes.HANDLE, LPVOID, ctypes.wintypes.DWORD)
...
GetQueuedCompletionStatus.argtypes = (ctypes.wintypes.HANDLE, LPVOID, LPVOID, ctypes.POINTER(OVERLAPPED), ctypes.wintypes.DWORD)
...
PostQueuedCompletionStatus.argtypes = (ctypes.wintypes.HANDLE, ctypes.wintypes.DWORD, ctypes.wintypes.DWORD, ctypes.POINTER(OVERLAPPED))
...
WATCHDOG_FILE_NOTIFY_FLAGS = reduce(lambda x, y: x | y, [FILE_NOTIFY_CHANGE_FILE_NAME, FILE_NOTIFY_CHANGE_DIR_NAME, FILE_NOTIFY_CHANGE_ATTRIBUTES, FILE_NOTIFY_CHANGE_SIZE, FILE_NOTIFY_CHANGE_LAST_WRITE, FILE_NOTIFY_CHANGE_SECURITY, FILE_NOTIFY_CHANGE_LAST_ACCESS, FILE_NOTIFY_CHANGE_CREATION])
BUFFER_SIZE = 2048
