...
if sys.version_info < (2, 7, 0):
    ...
    import select
from wandb_watchdog.observers.api import BaseObserver, EventEmitter, DEFAULT_OBSERVER_TIMEOUT, DEFAULT_EMITTER_TIMEOUT
from wandb_watchdog.utils.dirsnapshot import DirectorySnapshot
from wandb_watchdog.events import DirMovedEvent, DirDeletedEvent, DirCreatedEvent, DirModifiedEvent, FileMovedEvent, FileDeletedEvent, FileCreatedEvent, FileModifiedEvent, EVENT_TYPE_MOVED, EVENT_TYPE_DELETED, EVENT_TYPE_CREATED
MAX_EVENTS = 4096
O_EVTONLY = 32768
