...
def one(iterable: Iterable[T], too_short: type[Exception] | Exception | None=None, too_long: type[Exception] | Exception | None=None) -> T:
    ...
    try:
        ...
        return obj
    raise too_long or ValueError('Expected 1 item in iterable, got multiple') from None
