...
from lumina._strutils import b64decode_ascii, b64encode_ascii, nameof
from lumina.sdk.artifacts._models import ArtifactsBase
...
class MemberId:
    ...
    def from_obj(cls, obj: MemberOrId, /) -> MemberId:
        ...
        raise TypeError(f'Member arg must be a {nameof(User)!r}, {nameof(Team)!r}, or a user/team ID. Got: {nameof(type(obj))!r}')
